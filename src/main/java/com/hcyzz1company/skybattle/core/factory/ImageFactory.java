 ...
 *
 * <p>This class follows the Factory Design Pattern, centralizing the creation of Image objects.
 * In the future, this factory can be extended to support more complex image creation logic.</p>
 */
public class ImageFactory {
     ...
     *
     * <p>If the image fails to load due to an exception, a fallback "load fail" image is returned instead.
     * This ensures the application has a graceful way to handle missing or corrupted image files.</p>
     *
